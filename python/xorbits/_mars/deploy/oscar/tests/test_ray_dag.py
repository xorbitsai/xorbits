...
@pytest.mark.parametrize(
    ...
    [
        {
            "config": {
                "task.task_preprocessor_cls": "xorbits._mars.deploy.oscar.tests."
                "test_clean_up_and_restore_func.RayBackendFuncTaskPreprocessor",
                "subtask.subtask_processor_cls": "xorbits._mars.deploy.oscar.tests."
                "test_clean_up_and_restore_func.RayBackendFuncSubtaskProcessor",
            }
        }
    ],
    indirect=True,
