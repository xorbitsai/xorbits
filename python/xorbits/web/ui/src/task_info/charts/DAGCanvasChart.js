...
export default class DAGCanvasChart extends React.Component {
    ...
    if (
      ...
      this.props.dependencies.forEach((dependency) => {
        const dependencyClass =
          dependency.linkType === 1 ? 'linkType-1' : 'linkType-0'
        ...
        const dependencyElement = {
          data: {
            ...
            sourceNodeName:
              sourceNodeDetail === undefined ? '' : sourceNodeDetail.name,
            targetNodeName:
              targetNodeDetail === undefined ? '' : targetNodeDetail.name,
          },
          group: 'edges',
  ...
  render() {
    return (
      <React.Fragment>
        <div id={this.props.graphName} style={this.props.dagStyle} />
        <div id="node-tooltip" />
      </React.Fragment>
    )
  }
