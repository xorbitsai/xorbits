...
def send_1_to_1(n: int = None, cpu: bool = True):
    ...
    all_data = xmars.execute(list(band_to_gen_data.values()))
    progress = 0.1
...
class TransferPackageSuite:
    ...
    def setup(self):
        try:
            ...
            pass
        xmars.new_session(n_worker=2, n_cpu=8)
